    ...
    const columns: any = [
        {
            ...
            render: (text: any, record: any, index: any) => {
                const number =
                    (addressPageNum - 1) * addressPageSize + index + 1;
                return number;
            },
        },
        {
                ...
                <Space size="middle">
                    <PortalIcon
                        ...
                        onClick={() => {
                            ...
                            openModal(ADDRESS_CONTROL_MODAL_ID, {
