...
export const getChartOption = (chartData: ChartItemModel[] | null) => ({
    tooltip: {
        trigger: 'axis',
        confine: true,
        borderWidth: 0,
        ...
        formatter: (params: any) => {
            ...
            params.forEach((item: any) => {
                ...
                } else if (item.seriesId === SeriesId.PowerGeneration) {
                    unit = '万kWh';
    ...
    series: [
        ...
        },
        {
            ...
            data: chartData?.map((item) => item.correctelec),
            z: -1,
        },
        {
            ...
            data: chartData?.map((item) => item.pba),
            z: -2,
        },
    ],
});
